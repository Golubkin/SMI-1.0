...
TEST(SMIfloor, Vmenst) // Well done
{
...
TEST(SMIround, NumberRound) // Well done
{
...
TEST(SMIfact, Factorial) // Well done
{
...
TEST(SMIexp, Exponenta) // Well done
{
...
TEST(SMIpow, XvStepenyN) // Well done
{  
